...
import {ReactComponent as Gnome} from "../assets/Gnome1.svg"
import {ReactComponent as Snowman} from "../assets/Snowman.svg"
...
export default function Trip() {
    ...
    return <PageContainer>
        ...
        <div className="columns is-5 is-variable is-align-items-flex-end">
            <div className="column">
                ...
                {status && status.balance !== 0 && <article className={`message mt-2 ${status.balance > 0 ? 'is-success' : 'is-danger'}`}>
                ...
                <article className={`message mt-2 ${trip.status === TripStatus.AcceptingOrders ? 'is-success' : 'is-info'}`}>
            ...
            <div
                className="column is-flex-grow-0"
            >
                <Gnome
                    width={70}
                />
